...
#geofence_radius = 30  # Adjust as necessary
...
existing_logs = [f for f in os.listdir(log_dir) if f.startswith("roadlog_") and f.endswith(".csv")]
...
# Create new log file
log_filename = f"roadlog_{next_seq}.csv"
csv_file = os.path.join(log_dir, log_filename)

# csv_file = f'/home/vivek/DL/Logs/raw/road_data_{time_str}.csv'
